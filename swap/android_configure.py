...
if os.path.exists("./configure"):
    os.system("./configure --dest-cpu=" + DEST_CPU + " --dest-os=android --without-inspector --without-intl --without-node-snapshot --without-node-code-cache --without-npm --without-report --without-siphash --without-corepack --with-arm-float-abi=hard --openssl-no-asm --with-arm-fpu=neon --cross-compiling --partly-static")
